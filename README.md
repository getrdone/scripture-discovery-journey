...
Project workspace for curiosity-driven Scripture studies, video content, graphics, and interactive web experiences.

## Canonical source library

Bible-study source records, approved extracts, generated indexes, and the searchable SQLite database live in the private `getrdone/bible-study-source-materials` repository.

...
3. Use the [learning-pattern router](https://github.com/getrdone/agent-skills/blob/main/skills/curiosity-driven-scripture-journey/versions/3.3.1/references/learning-patterns.md) to select 3–5 patterns from at least two families. Give each one a different learning job.
4. Record the selection in the project's `learning_pattern_plan`.
5. Load only the selected family files:
   - [guided understanding](https://github.com/getrdone/agent-skills/blob/main/skills/curiosity-driven-scripture-journey/versions/3.3.1/references/pattern-guided-understanding.md)
   - [active discovery](https://github.com/getrdone/agent-skills/blob/main/skills/curiosity-driven-scripture-journey/versions/3.3.1/references/pattern-active-discovery.md)
   - [feedback and mastery](https://github.com/getrdone/agent-skills/blob/main/skills/curiosity-driven-scripture-journey/versions/3.3.1/references/pattern-feedback-and-mastery.md)
   - [access, agency, and momentum](https://github.com/getrdone/agent-skills/blob/main/skills/curiosity-driven-scripture-journey/versions/3.3.1/references/pattern-access-agency-momentum.md)
...
For observed platform flows and primary references, use the [provenance ledger](https://github.com/getrdone/agent-skills/blob/main/skills/curiosity-driven-scripture-journey/versions/3.3.1/references/learning-pattern-sources.md).
